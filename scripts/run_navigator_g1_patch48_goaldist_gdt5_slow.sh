...
export NAVIGATOR_DIAGNOSTIC_UNIT="${NAVIGATOR_DIAGNOSTIC_UNIT:-navigator-g1-patch48-goaldist-gdt5-lr1e5-128k-v1}"
export NAVIGATOR_CHECKPOINT_DIR="${NAVIGATOR_CHECKPOINT_DIR:-checkpoints/navigator-g1-patch48-goaldist-gdt5-lr1e5-128k-v1}"
export NAVIGATOR_VALIDATION_OUTPUT_DIR="${NAVIGATOR_VALIDATION_OUTPUT_DIR:-results/navigator_nnunet/g1-patch48-goaldist-gdt5-lr1e5-128k-v1-validation}"
...
export NAVIGATOR_TOTAL_TIMESTEPS="${NAVIGATOR_TOTAL_TIMESTEPS:-128000}"
...
export NAVIGATOR_LEARNING_RATE=0.00001
export NAVIGATOR_BEHAVIOR_CLONING_EPOCHS=0
export NAVIGATOR_GDT_REWARD_SCALE=5
