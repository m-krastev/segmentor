...
TARGET_DISTANCE_PENALTY_RADIUS_MM="${NAVIGATOR_TARGET_DISTANCE_PENALTY_RADIUS_MM:-600}"
...
EPISODIC_CELL_REWARD_SCALE="${NAVIGATOR_EPISODIC_CELL_REWARD_SCALE:-0}"
EPISODIC_CELL_SIZE_MM="${NAVIGATOR_EPISODIC_CELL_SIZE_MM:-6}"
